...
# Load the data
file_path = '/Users/bjorn/Desktop/DavidAutomationCode/3heatmappys/Ranked_Genes2.csv' 
csv_path = '/Users/bjorn/Desktop/DavidAutomationCode/3heatmappys/Ranked_Genes2.csv' 
...
ax.set(title="Heatmap of Shared Terms Between Studies", xlabel="Study Names", ylabel="Study Names")
plt.tight_layout()
heatmap_image_path = 'HeatmapPotentialRatioTerms1.14.png'  # Replace with your desired file path
